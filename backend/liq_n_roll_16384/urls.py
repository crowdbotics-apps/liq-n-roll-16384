"""liq_n_roll_16384 URL Configuration
...
admin.site.site_header = "Liq N Roll"
admin.site.site_title = "Liq N Roll Admin Portal"
admin.site.index_title = "Liq N Roll Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Liq N Roll API",
        default_version="v1",
        description="API documentation for Liq N Roll App",
    ),
    public=True,
